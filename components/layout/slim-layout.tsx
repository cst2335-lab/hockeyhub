...
export function SlimLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen shrink-0 justify-center md:px-12 lg:px-0">
      <div className="relative z-10 flex flex-1 flex-col bg-card text-card-foreground px-4 py-10 shadow-2xl sm:justify-center md:flex-none md:px-28 border-r border-border dark:border-slate-700">
